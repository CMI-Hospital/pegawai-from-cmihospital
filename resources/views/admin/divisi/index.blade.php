...
@section('content')
    <div class="panel bg-info">
        <div class="panel-heading">
            <em>
                <h6>Pada halaman ini terdapat daftar Role yang ada di dalam perusahaan ini. masing-masing Role bisa
                    dihapus dan diedit.
                </h6>
            </em>
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <a href="{{ route('divisi.create') }}"><i class="icon-file-plus"></i> Tambah Data Role </a>
        </div>

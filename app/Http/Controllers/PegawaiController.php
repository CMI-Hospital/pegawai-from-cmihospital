...
class PegawaiController extends Controller
{
   ...
   // }
    ...
    public function cariId(Request $request)
    {
        ...
        $secondDatabaseData = IdPegawai::where('no_pegawai', $id_pegawai)->get();
        //$secondDatabaseData = Pegawai2::where('no_pegawai', $id_pegawai)->get();
        ...
        // Check if the no_pegawai_id already exists in the Pegawai table
        $pegawaiExists = Pegawai::where('no_pegawai', $id_pegawai)->exists();
        
        return view('login.register', [
            'secondDatabaseData' => $secondDatabaseData,
            'jabatan' => $jabatan,
            'divisi' => $divisi,
            'role' => $role,
            'pegawai' => $pegawai,
